               ...
               <div className="fixed top-16 w-[280px] h-screen overflow-y-auto hiddenScrollbar pt-8 px-4">
                  ...
                  <div className="mt-2 IRANSansWeb">
                     <div className="flex flex-wrap">
                        <div className="text-xs p-2 text-[#0000008F] hover:text-black transition-all duration-300 cursor-pointer">دربارهٔ دیوار</div>
                        <div className="text-xs p-2 text-[#0000008F] hover:text-black transition-all duration-300 cursor-pointer">دریافت برنامه</div>
                        <div className="text-xs p-2 text-[#0000008F] hover:text-black transition-all duration-300 cursor-pointer">اتاق خبر</div>
                        <div className="text-xs p-2 text-[#0000008F] hover:text-black transition-all duration-300 cursor-pointer">کسب‌وکارها</div>
                        <div className="text-xs p-2 text-[#0000008F] hover:text-black transition-all duration-300 cursor-pointer">پشتیبانی و قوانین</div>
                     </div>
